...
function NavLink({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex w-full items-center gap-4 px-6 py-4 text-left font-display text-xs font-bold tracking-widest uppercase transition-all duration-300",
        active
          ? "border-cyan-400 border-r-4 bg-cyan-400/5 text-cyan-400"
...
export default function App() {
  ...
  return (
    <div ref={rootRef} className="min-h-svh overflow-x-hidden text-[#e5e2e1] antialiased">
      <input ref={fileInputRef} type="file" className="hidden" onChange={(e) => onFiles(e.target.files)} />

      {/* SideNavBar */}
      <aside
        data-gsap-in
        className="fixed top-0 left-0 z-50 flex h-full w-64 flex-col border-r border-white/5 bg-[#050505] py-8"
      >
        <div className="mb-12 px-8">
          <h1 className="font-display text-2xl font-black tracking-widest text-cyan-500">MalSentry</h1>
          <p className="font-mono-v mt-3 max-w-[13.5rem] text-[10px] leading-relaxed tracking-wide text-zinc-500">
        ...
        <div className="mt-auto px-6">
          <button
            ...
            className="font-display w-full rounded-lg border border-cyan-400/30 bg-cyan-400/10 py-3 text-sm font-bold tracking-widest text-cyan-400 uppercase transition-all hover:bg-cyan-400 hover:text-black active:scale-95"
          >
            Import Node
          </button>
          <div className="mt-8 flex items-center gap-3 rounded-xl bg-white/5 p-3">
            <div className="flex size-10 items-center justify-center overflow-hidden rounded-full border border-cyan-400/20 bg-cyan-950">
              <UserCircle className="size-6 text-cyan-400/80" />
            </div>
            <div>
              <p className="text-xs font-bold">Operator</p>
              <p className="text-[10px] font-medium text-zinc-500">Node Controller</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="ml-64 flex min-h-svh flex-col">
        ...
        <header
          data-gsap-in
          className="fixed top-0 right-0 left-64 z-40 flex h-16 items-center justify-between border-b border-white/10 bg-black/80 px-8 shadow-[0_0_20px_rgba(0,240,255,0.05)] backdrop-blur-md"
        >
          <div className="flex items-center gap-4">
            <div className="group relative">
              ...
              <input
                readOnly
                className="font-body w-64 rounded-full border border-white/10 bg-white/5 py-1.5 pr-4 pl-10 text-sm transition-all placeholder:text-zinc-600 focus:border-cyan-400/50 focus:ring-0 focus:outline-none"
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4 border-r border-white/10 pr-6">
              <button type="button" className="text-zinc-500 transition-colors hover:text-cyan-400" aria-label="Notifications">
                <Bell className="size-5" />
              </button>
              <button type="button" className="text-zinc-500 transition-colors hover:text-cyan-400" aria-label="History">
                <History className="size-5" />
              </button>
              <button type="button" className="text-zinc-500 transition-colors hover:text-cyan-400" aria-label="Account">
            ...
            <Button
              ...
              onClick={scanNow}
              disabled={detecting}
              className="rounded bg-cyan-400 px-6 py-1.5 font-display text-sm font-bold tracking-tight text-black shadow-none hover:bg-cyan-300 active:scale-95"
            >
              {detecting ? (
        ...
        <main className="mt-16 flex-1 overflow-y-auto p-10">
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 flex flex-col gap-6 lg:col-span-8">
              ...
              >
                ...
                <div className="relative flex h-72 w-72 items-center justify-center rounded-full border-[12px] border-white/5">
                  ...
                  <div className="z-10 text-center">
                    <span className="material-symbols-outlined mb-2 text-6xl text-cyan-400" style={{ fontVariationSettings: "'FILL' 1" }}>
                      verified_user
                    </span>
                    <h2 className="font-display text-4xl leading-tight font-semibold tracking-tight text-cyan-400 md:text-5xl">
                      {prediction?.class === "Malicious" ? "Alert" : "Detector"}
                    </h2>
                    <p className="font-mono-v mt-2 max-w-[20rem] text-center text-xs leading-relaxed tracking-[0.12em] text-zinc-500 uppercase">
                ...
                <div className="mt-8 flex gap-12">
                  <div className="text-center">
                    <p className="mb-1 text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Threat Level</p>
                    <p className={cn("font-display text-lg font-bold", threatColor)}>{threatLabel}</p>
                  </div>
                  <div className="border-x border-white/10 px-12 text-center">
                    <p className="mb-1 text-[10px] font-bold tracking-widest text-zinc-500 uppercase">AI Heuristics</p>
                    <p className="font-display text-lg font-bold text-cyan-400">{modelReady ? "ACTIVE" : "SIM"}</p>
                  </div>
                  <div className="text-center">
                    <p className="mb-1 text-[10px] font-bold tracking-widest text-zinc-500 uppercase">Engine</p>
                    <p className="font-display text-lg font-bold text-zinc-300">{health?.model_type ?? "—"}</p>
                  </div>
                </div>
              </section>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <div data-gsap-in className="glass-card glow-cyan rounded-xl p-6">
                  <div className="mb-4 flex items-start justify-between">
                    ...
                    <span className="rounded bg-white/5 px-2 py-0.5 text-[10px] text-zinc-400">REAL-TIME</span>
                  </div>
                  <p className="mb-1 text-xs font-semibold tracking-widest text-zinc-400 uppercase">Active Threats</p>
                ...
                <div data-gsap-in className="glass-card rounded-xl p-6">
                  <div className="mb-4 flex items-start justify-between">
                    ...
                    <span className="rounded bg-cyan-400/10 px-2 py-0.5 text-[10px] text-cyan-400">SESSION</span>
                  </div>
                  <p className="mb-1 text-xs font-semibold tracking-widest text-zinc-400 uppercase">Files Scanned</p>
                  <h3 className="font-display text-3xl font-medium text-white">{sessionScans}</h3>
                </div>
                <div data-gsap-in className="glass-card rounded-xl p-6">
                  <div className="mb-4 flex items-start justify-between">
                    <span className="material-symbols-outlined text-zinc-500">bolt</span>
                    <span className="rounded bg-green-500/10 px-2 py-0.5 text-[10px] text-green-500">API</span>
                  </div>
                  <p className="mb-1 text-xs font-semibold tracking-widest text-zinc-400 uppercase">Max Upload</p>
                  <h3 className="font-display text-3xl font-medium text-white">{health?.max_upload_size_mb ?? 50}M</h3>
                </div>
              </div>
              ...
              <section data-gsap-in className="glass-card rounded-2xl p-8">
                <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <h3 className="font-display text-xl font-medium text-white">Classifier Output</h3>
                    <p className="text-xs text-zinc-500">Benign vs malicious probability mass</p>
                  </div>
                ...
                {chartData.length > 0 ? (
                  ...
                  <div className="flex h-48 items-end gap-1 px-2">
                    {loadBars.map((h, i) => (
                      <div
                        key={i}
                        className="hover:bg-cyan-400/35 w-full rounded-t-sm bg-cyan-400/20 transition-colors"
                        style={{ height: `${h}%` }}
                      />
                    ))}
                  </div>
                ...
                <div ref={dropRef} data-gsap-results>
                  <div
                    className={cn(
                      ...
                      dragOver && "ring-1 ring-cyan-400/30"
                    )}
                  >
                    <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                      <div>
                        <h3 className="font-display text-xl font-medium text-white">Node Ingest</h3>
                        <p className="text-xs text-zinc-500">Drop payload · binary visualization · POST /detect</p>
                      </div>
                      <div className="flex gap-2">
                        ...
                        <Button
                          ...
                          className="bg-cyan-400/15 font-display text-cyan-400 hover:bg-cyan-400 hover:text-black"
                        >
                    ...
                    <button
                      ...
                      onClick={() => fileInputRef.current?.click()}
                      className={cn(
                        "flex w-full flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-white/15 bg-white/[0.04] px-6 py-12 transition-colors",
                    ...
                    >
                      {uploading ? (
                        ...
                        <span className="material-symbols-outlined text-4xl text-zinc-500">upload_file</span>
                      )}
                      <p className="font-display text-sm font-bold tracking-wide text-zinc-300 uppercase">
                        Drop file or click to ingest
                      </p>
                      <p className="text-xs text-zinc-600">⌘O · Space when ready · Esc clear</p>
                    </button>
                    ...
                    {upload && !uploading && (
                      <div className="mt-8 space-y-6 border-t border-white/10 pt-8">
                        <div className="flex flex-wrap items-start justify-between gap-4">
                          <div>
                            <p className="font-mono-v text-[10px] tracking-wider text-zinc-500 uppercase">Object</p>
                            <p className="font-display text-lg font-semibold text-white">{upload.filename}</p>
                            <p className="text-xs text-zinc-500">
                              {formatBytes(upload.file_size)} · {upload.model_type}
                            </p>
                          </div>
                          <Shield className="size-8 text-cyan-400/60" />
                        </div>
                        ...
                        <div className="space-y-3">
                          <p className="text-xs font-semibold tracking-widest text-zinc-500 uppercase">Probabilities</p>
                          <div className="space-y-2">
                            ...
                            <div className="h-2 overflow-hidden rounded-full bg-white/10">
                              <div
                                ref={benignBarRef}
                                className="h-full w-full origin-left rounded-full bg-cyan-400/80"
                        ...
                        {prediction && (
                          <div className="flex items-start gap-4 rounded-xl border border-white/10 bg-white/[0.04] p-4">
                            {prediction.class === "Malicious" ? (
                              <ShieldAlert className="mt-0.5 size-8 shrink-0 text-red-400" />
                            ) : (
                              <ShieldCheck className="mt-0.5 size-8 shrink-0 text-cyan-400" />
                            )}
                            <div>
                              <p className="font-display text-lg font-bold text-white">{prediction.class}</p>
                              <p className="text-sm text-zinc-500">
                                Confidence {prediction.confidence}%
                                {prediction.simulation ? " · SIM" : ""}
                              </p>
                              {prediction.error && (
                                <p className="mt-1 text-xs text-amber-400">{prediction.error}</p>
                              )}
                            </div>
                          </div>
                        )}
                        {detecting && (
                          <div className="mt-2">
                            <Progress value={66}>
                              ...
                              <ProgressTrack>
                                <ProgressIndicator className="bg-cyan-400" />
                              </ProgressTrack>
                            </Progress>
                          </div>
                        )}
            ...
            <div className="col-span-12 flex flex-col gap-6 lg:col-span-4">
              ...
              >
                <div className="mb-6 flex items-center justify-between">
                  <h3 className="font-display text-xl font-medium text-white">Recent Activity</h3>
                  <button
                    type="button"
                ...
                <div className="flex flex-1 flex-col gap-4 overflow-y-auto pr-1">
                  {activity.length === 0 ? (
                    <p className="text-sm text-zinc-600">No scan events yet. Run analysis to populate the feed.</p>
                  ) : (
                    activity.map((row) => (
                      <div
                        key={row.id}
                        className={cn(
                          "flex items-center gap-4 rounded-xl border border-white/5 bg-white/5 p-4",
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            row.status === "threat" ? "bg-red-500/10 text-red-500" : "bg-green-500/10 text-green-500"
                          )}
                        >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="font-mono-v text-[10px] text-zinc-500">HASH: {row.hash}</p>
                        </div>
                        <div className="shrink-0 text-right">
                          ...
                          <p
                            className={cn(
                              ...
                              row.status === "threat" ? "text-red-500" : "text-green-500"
                            )}
                          >
                ...
                <div className="mt-6 border-t border-white/10 pt-6">
                  <div className="rounded-xl border border-cyan-400/10 bg-cyan-400/5 p-4">
                    <h4 className="mb-2 text-xs font-bold tracking-widest text-cyan-400 uppercase">Security Tip</h4>
          ...
          <footer className="mt-12 border-t border-white/10 pt-6 text-center font-mono-v text-[10px] tracking-wider text-zinc-600 uppercase">
      ...
      <Dialog open={malwareDialogOpen} onOpenChange={setMalwareDialogOpen}>
        <DialogContent className="border-white/10 bg-[#131313] sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 font-display text-red-400">
          ...
          <DialogFooter className="flex flex-col gap-2 sm:flex-row sm:justify-end">
            ...
            <Button type="button" className="bg-cyan-400 text-black hover:bg-cyan-300" onClick={downloadReport}>
              Export JSON
            </Button>
          </DialogFooter>
        </DialogContent>
